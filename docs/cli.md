...
symlink within the skill tree. Daem hashes each shared resolved route once per
planning pass, then streams the exact planned directory identity into private
