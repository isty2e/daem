...
retained-name allowance again, but daem revalidates their exact directory
inventory identity on every reuse and once more before returning any plan or
nothing-to-import result. A changed root aborts the observation instead of
returning an incomplete preview. Extension inventory
