...
This page is the compact user-facing view of current tested behavior. Use the
...
The matrix is a derived summary, not implementation input or a resource
ontology. Each cell describes only the named surface and scope. The notes and
route summaries below state the corresponding guarantees and limits.
