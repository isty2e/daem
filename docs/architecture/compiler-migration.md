...
| `packagePlacementRows` exact lists | defer delete | Still the affinity lookup for placed packages. Shadow does not bless the catalogue as ontology. Closeout may replace after equivalent coverage. |
