...
This reference describes the durable records and limits behind managed
ownership and interrupted-operation recovery. For the overview, see
[Concepts](concepts.md). For commands to use after a failure, see
[Troubleshooting](troubleshooting.md#apply-was-interrupted).
...
- [Recovery journal](#recovery-journal)
  - [Journal retirement](#journal-retirement)
  - [Removal intents](#removal-intents)
  - [Recovery work budgets](#recovery-work-budgets)
  - [Retained cleanup](#retained-cleanup)
  - [Forward-operation barriers](#forward-operation-barriers)
  - [Older tombstones](#older-tombstones)
