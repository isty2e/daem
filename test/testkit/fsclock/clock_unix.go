...
// The fixture and t.TempDir must share a filesystem; neither path nor its parent
// is modified. A non-progressing clock skips the dependent test, not a failed
