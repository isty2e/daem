...
func TestPackageRefDerivesSelectorAssuranceByEcosystem(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "npm maximum safe major", ecosystem: EcosystemNPM, selector: "9007199254740991.0.0", want: selectorAssuranceExactVersion},
		{name: "npm unsafe major", ecosystem: EcosystemNPM, selector: "9007199254740992.0.0", want: selectorAssuranceFloating},
		{name: "npm unsafe minor", ecosystem: EcosystemNPM, selector: "0.9007199254740992.0", want: selectorAssuranceFloating},
		{name: "npm unsafe patch", ecosystem: EcosystemNPM, selector: "0.0.9007199254740992", want: selectorAssuranceFloating},
		{name: "npm large prerelease identifier", ecosystem: EcosystemNPM, selector: "1.2.3-9007199254740992", want: selectorAssuranceExactVersion},
		{name: "npm maximum length exact", ecosystem: EcosystemNPM, selector: "1.2.3+" + strings.Repeat("a", 250), want: selectorAssuranceExactVersion},
		{name: "npm overlong exact", ecosystem: EcosystemNPM, selector: "1.2.3+" + strings.Repeat("a", 251), want: selectorAssuranceFloating},
