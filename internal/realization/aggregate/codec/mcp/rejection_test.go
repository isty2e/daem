...
func TestClaudeProjectMCPProjectionRejectsUnsupportedShapesWithReasonCodes(t *testing.T) {
	...
	cases := []struct {
		...
		{name: "duplicate top level key", input: []byte(`{"mcpServers":{},"mcpServers":{}}`), want: MCPProjectionReasonProjectionEquivalenceUndefined},
		...
		{name: "duplicate server key", input: []byte(`{"mcpServers":{"context7":{"type":"stdio","command":"npx"},"context7":{"type":"stdio","command":"node"}}}`), want: MCPProjectionReasonProjectionEquivalenceUndefined},
		...
		{name: "duplicate managed field", input: []byte(`{"mcpServers":{"context7":{"type":"stdio","command":"npx","command":"node"}}}`), want: MCPProjectionReasonProjectionEquivalenceUndefined},
		...
		{name: "duplicate env key", input: []byte(`{"mcpServers":{"context7":{"type":"stdio","command":"npx","env":{"TOKEN":"${TOKEN}","TOKEN":"${OTHER_TOKEN}"}}}}`), want: MCPProjectionReasonProjectionEquivalenceUndefined},
