...
func aggregateAddressKey(address aggregate.ProjectionAddress) string {
	...
	return string(document.Target()) + "\x00" + string(document.Scope()) + "\x00" + document.AggregateRoot() + "\x00" + address.PlacementID() + "\x00" + string(address.MergeUnit()) + "\x00" + string(address.ContentPath())
}
