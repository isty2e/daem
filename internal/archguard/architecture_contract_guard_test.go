...
var hostSpecializationOwners = map[string]string{
	...
	"internal/assurance/observe/mcp/provider/host":  "private provider-package observer owns host package inventory, exact version, and profile dispatch",
...
var testToolPackageAdmissions = map[string]testToolAdmission{
	...
	"internal/assurance/pathauthority/pathtest": {Reason: "constructor-only exact path authority fixtures are test support", Kind: testToolHelperPackage},
