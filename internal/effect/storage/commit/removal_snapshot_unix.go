...
func captureRemovalDirectorySnapshot(
	...
	return verifyRemovalDirectorySnapshot(ctx, directoryFD, directoryPath, *entry, authority, faults)
}
...
func verifyRemovalDirectoryTreeSnapshot(
	...
	if err := verifyRemovalDirectorySnapshot(ctx, directoryFD, directoryPath, entry, authority, faults); err != nil {
		return err
	}
