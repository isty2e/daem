...
type recoveryRemovalTransition struct {
	Before        *recoveryBeforePathDTO   `json:"before,omitempty"`
	ExpectedAfter *recoveryExpectedPathDTO `json:"expected_after,omitempty"`
}
...
// recoveryEntry is the exact journal-v13 persistence DTO. Subject is the sole
...
type recoveryEntry struct {
	...
	RemovalTransition      *recoveryRemovalTransition `json:"removal_transition,omitempty"`
...
// recoveryStateIdentity is the exact nested journal-v13 persistence DTO used to
